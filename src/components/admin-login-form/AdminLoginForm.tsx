...
export default function AdminLoginForm() {
  ...
  const login: SubmitHandler<AdminLoginType> = (data) => {
    console.log(data);
  };

  return (
    <form onSubmit={handleSubmit(login)} className={styles.formWrapper}>
      ...
      <Button loading={isSubmitting}>Giriş yap</Button>
    </form>
  );
}
